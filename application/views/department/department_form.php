                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <?php echo form_open_multipart('department/create','class="form-inner"') ?> 
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-xs-2 col-form-label"><?php echo display('department_name') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-10">
                             ...
                             <div class="form-group row">
                                <label for="main_department" class="col-xs-2 col-form-label"><?php echo display('main_department') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-10"> 
                                    <?php 
                             ...
                             <div class="form-group row">
                                <label for="flaticon" class="col-xs-2 col-form-label"><?php echo display('flaticon') ?></label>
                                <div class="col-xs-10"> 
                                    <?php 
                                        $flaticon = array(  
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <textarea name="description" class="form-control tinymce"  placeholder="<?php echo display('description') ?>"><?php echo $department->description ?></textarea>
                                </div>
                            </div>
